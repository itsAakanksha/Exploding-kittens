  ...
  const initialState = {
    deck: [
      ...
      { type: "CAT",img:cat, id: 2,isFlipped:false, },
      { type: "EXPLODING_KITTEN",img:explode, id:3,isFlipped:false,},
      { type: "DEFUSE" ,img:defuse, id:4,isFlipped:false,},
      { type: "DEFUSE" ,img:defuse, id:5,isFlipped:false,},
      { type: "SHUFFLE",img:shuffle , id:6,isFlipped:false,},
    ],
    drawnCards: [],
    isGameActive: false,
    gameover: false,
