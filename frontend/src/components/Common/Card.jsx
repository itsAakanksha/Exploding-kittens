...
export default function Card({ card }) {
  return (
    <div className="card-container w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 xl:w-32 xl:h-32 rounded-md overflow-hidden shadow-md transform transition-transform duration-300 hover:scale-105">
      <div
